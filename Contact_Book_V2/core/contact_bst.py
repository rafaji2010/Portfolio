...
if __name__ == "__main__":
    ...
    # Add sample contacts
    contacts = [
        Contact(first_name="John", last_name="Doe", email="john@example.com", phone="555-111-2222"),
        Contact(
            first_name="Jane", last_name="Smith", email="jane@example.com", phone="555-333-4444"
        ),
        Contact(
            first_name="Alice", last_name="Brown", email="alice@example.com", phone="555-555-6666"
        ),
        Contact(first_name="Bob", last_name="Doe", email="bob@example.com", phone="555-777-8888"),
    ]
